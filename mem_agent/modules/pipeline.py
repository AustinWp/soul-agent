...
def _pipeline_loop(queue: IngestQueue, engine: MemEngine, running: threading.Event) -> None:
...
def start_pipeline_thread(queue: IngestQueue, engine: MemEngine) -> tuple[threading.Thread, threading.Event]:
