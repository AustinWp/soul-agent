...
def _call_daemon(method: str, path: str, **kwargs: Any) -> dict | str:
    ...
    try:
        ...
        return "Error: soul-agent daemon is not running. Start it with 'soul service start'."
